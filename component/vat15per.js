...
class vat15per extends Component{
    constructor(props) {
        super(props);
        this.state = {
...
handleOnPress(value){
  ...
  render() {
    ...
    return (
      ...
      <Text style={styles.h2}>ค่างวด : {490000 - 73500} บาท</Text>
      <Text>    </Text>
      <Text style={styles.nameCar}>ผ่อน 4 ปี อัตราดอกเบี้ย 2.5%</Text>
      <RadioButton currentValue={this.state.value} value={(490000 - 73500)/48 + (((490000 - 73500)/48)*2.5)/100} onPress={this.handleOnPress.bind(this)}/>
    
      <Text style={styles.nameCar}>ผ่อน 5 ปี อัตราดอกเบี้ย 3.0%</Text>
      <RadioButton  currentValue={this.state.value} value={(490000 - 73500)/60 + (((490000 - 73500)/60)*3.0)/100} onPress={this.handleOnPress.bind(this)} />
      
      <Text style={styles.nameCar}>ผ่อน 6 ปี อัตราดอกเบี้ย 3.5%</Text>
      <RadioButton currentValue={this.state.value} value={(490000 - 73500)/72 + (((490000 - 73500)/72)*3.5)/100} onPress={this.handleOnPress.bind(this)} />
      
      <Text style={styles.nameCar}>ผ่อน 7 ปี อัตราดอกเบี้ย 4.0%</Text>
      <RadioButton currentValue={this.state.value} value={(490000 - 73500)/84 + (((490000 - 73500)/84)*4.0)/100} onPress={this.handleOnPress.bind(this)} />
